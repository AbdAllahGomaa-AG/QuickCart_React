...
export default function Footer() {
  return (
    <>
      <footer className="w-full bg-[#F3F4F6] mt-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              <img src={image} alt="" />

              <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left leading-relaxed line-clamp-6 tracking-wider">
                JinStore is a leading e-commerce platform that offers a wide
                range of products and services to customers. Our platform is
                designed to provide a seamless shopping experience, with a
                user-friendly interface and a wide selection of products.
              </p>
              <a className="py-2.5 cursor-pointer px-5 h-9 block w-fit bg-purple rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-purple/80 lg:mx-0">
                Contact us
              </a>
            </div>
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-gray-500 ">
                JinStore 2024, All rights reserved.
              </span>
